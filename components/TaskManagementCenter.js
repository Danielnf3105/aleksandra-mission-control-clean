...
import { CheckSquare, Clock, AlertCircle, User, Calendar, ArrowRight, Plus, Filter, Search, MoreVertical } from 'lucide-react';
...
const TaskManagementCenter = () => {
  const [tasks, setTasks] = useState([
    ...
    {
      id: 'TASK-004',
      title: 'Implement Cost Tracking Analytics',
      description: 'Advanced cost analysis, token usage tracking, and budget monitoring',
      status: 'in-progress',
      priority: 'medium',
    ...
    {
      id: 'TASK-005',
      title: 'Research Enterprise Dashboard Features',
      description: 'Analyze enterprise mission control patterns and implement best practices',
      status: 'in-progress',
      priority: 'medium',
      ...
      <div className=\"grid grid-cols-4 gap-6 mb-6\">
        ...
        <div className=\"space-y-4\">
          ...
          <div className=\"bg-gray-900 border border-gray-700 rounded-lg p-4\">
            ...
            <div className=\"space-y-3\">
              {['Aleksandra Main', 'Analytics Agent', 'Research Agent'].map(assignee => {
          ...
          <div className=\"bg-gray-900 border border-gray-700 rounded-lg p-4\">
            ...
            <div className=\"space-y-3 text-xs\">
              ...
              <div className=\"flex items-center space-x-2\">
                ...
                <span className=\"text-gray-400\">TASK-006 created</span>
              </div>
              <div className=\"flex items-center space-x-2\">
                <div className=\"w-2 h-2 bg-yellow-400 rounded-full\"></div>
                <span className=\"text-gray-400\">TASK-004 moved to progress</span>
              </div>
              <div className=\"flex items-center space-x-2\">
                <div className=\"w-2 h-2 bg-green-400 rounded-full\"></div>
            ...
            <div className=\"space-y-4 text-sm\">
              ...
              <div className=\"grid grid-cols-2 gap-4\">
                <div>
                  ...
                  <p className=\"text-white mt-1\">{selectedTask.estimatedHours}h</p>
                </div>
                <div>
                  <span className=\"text-gray-400\">Actual Hours:</span>
                  <p className=\"text-white mt-1\">{selectedTask.actualHours.toFixed(1)}h</p>
                </div>
              </div>
